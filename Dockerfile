...
RUN     curl $CURL_FLAGS -o bootstrap.min.css.map https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/css/bootstrap.min.css.map
RUN     curl $CURL_FLAGS -o bootstrap.bundle.min.js https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.bundle.min.js
RUN     curl $CURL_FLAGS -o bootstrap.bundle.min.js.map https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.bundle.min.js.map
